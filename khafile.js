...
project.targetOptions.android.permissions = ['android.permission.SET_ALARM'];
project.targetOptions.android.permissions = ['android.permission.READ_CALENDAR'];
project.targetOptions.android.permissions = ['android.permission.WRITE_CALENDAR'];
